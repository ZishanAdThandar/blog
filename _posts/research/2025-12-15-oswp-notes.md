...
image: /assets/images/oswp-notes.png
---
...
- **Wireless Fundamentals** – Adapter modes, monitor setup, injection testing  
- **WEP Attacks** – Fast cracking, replay attacks, fragmentation  
- **WPA/WPA2** – Handshake capture, deauth logic, PMKID attacks  
- **WPS Exploitation** – Pixie Dust, brute force, pin generation  
- **Troubleshooting** – Fix failed attacks, adapter issues, signal problems  
...
- OSWP Notes (PDF + Markdown)  
- Wireless attack decision trees  
- Adapter setup & troubleshooting  
- Exam-ready command references  
