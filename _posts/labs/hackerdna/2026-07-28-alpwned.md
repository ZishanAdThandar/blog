...
description: CTF writeup exploiting SQL injection in a Flask app to access an admin dashboard, then leveraging the Werkzeug debugger console for root RCE by computing the PIN.
category: hackerdna
