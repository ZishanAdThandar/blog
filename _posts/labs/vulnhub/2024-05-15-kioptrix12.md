---
layout: post
title: "Kioptrix Level 1.2 - LotusCMS RCE"
description: VulnHub Kioptrix 1.2 walkthrough — exploiting LotusCMS remote code execution and privilege escalation via the ht editor to gain root access.
category: vulnhub
---
