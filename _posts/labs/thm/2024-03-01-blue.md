...
description: TryHackMe Blue walkthrough — exploiting EternalBlue MS17-010 with Metasploit to gain SYSTEM shell on a vulnerable Windows machine, then harvesting hashes with Mimikatz.
category: thm
tags: [nmap, metasploit, machine]
---
...
Room Link: [https://thm.com/room/blue](https://thm.com/room/blue)

Badges: [https://thm.com/ZishanAdThandar/badges/blue](https://thm.com/ZishanAdThandar/badges/blue)
