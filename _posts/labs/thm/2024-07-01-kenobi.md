---
layout: default
title: Kenobi - TryHackMe walkthrough with Samba, ProFTPd and Privilege Escalation
description: TryHackMe Kenobi walkthrough — enumerating Samba shares, exploiting ProFTPd with searchsploit, and privilege escalation via SUID path variable manipulation.
category: thm
tags: [thm, nmap, metasploit, smb, rce, searchsploit]
---
...
Room Link: [https://thm.com/room/kenobi](https://thm.com/room/kenobi)
