...
description: OffSec Proving Grounds AuthBy walkthrough — advanced Windows enumeration, credential harvesting, and lateral movement techniques on an Intermediate-rated machine.
category: offsec
---
