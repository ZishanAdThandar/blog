...
{% for post in site.posts limit:6 %}
  <article class="post-card">
    <div class="post-meta" style="font-size: 0.8rem; color: var(--gray); margin-bottom: 0.5rem;">
      <span style="color: transparent; text-shadow: 0 0 0 #94a3b8;">🗓️</span> {{ post.date | date: "%b %d, %Y" }} • <span style="color: transparent; text-shadow: 0 0 0 #94a3b8;">🗂️</span>  {{ post.categories | first | capitalize }}
    </div>
    <h3>
